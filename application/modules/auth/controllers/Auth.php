    ...
    function register()
    {
        ...
        if (isset($_POST['register'])) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                // $activation_code = $this->ion_auth->generate_activation_code($identity);

                // $this->load->library('email');
                // $this->email->from('jasmineazzahra249@gmail.com', 'Jasmine Azzahra');
                // $this->email->to($email);
                // $this->email->subject('Aktivasi Akun');
                // $this->email->message('Klik link berikut untuk mengaktifkan akun Anda: ' . site_url('auth/activate/' . $activation_code));
                // $this->email->send();
